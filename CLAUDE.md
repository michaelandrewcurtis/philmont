...
### `FULL_ROUTE`
Array of `[lng, lat]` pairs forming the complete 12-day trail as a single LineString. Decimated from real GPX data (3,163 pts from 6,325 GPX points — step=2). `DAY_SEGMENTS` indices can be adjusted manually to fine-tune where each day's segment starts/ends.
